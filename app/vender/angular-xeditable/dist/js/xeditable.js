		...
		return editableDirectiveFactory({
			...
			render: function() {
				...
				**/
				...
				var buttonDatePicker = angular.element('<button type="button" class="mod-btn"><i class="glyphicon glyphicon-calendar"></i></button>');
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs3': {
      ...
      errorTpl:    '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="mod-btn"><span></span></button>',
      cancelTpl:   '<button type="button" class="mod-btn" ng-click="$form.$cancel()">'+
                     '<span></span>'+
                   '</button>',
